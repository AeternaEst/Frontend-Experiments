...
class Controlled extends Component<{}, ControlledState> {
  ...
  onFormChange(event: FormEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>): void {
    console.log(`event: ${event.currentTarget.name} : ${event.currentTarget.value}`);
  ...
  render() {
    const {
      textVal, selectVal, multiSelectVal, textAreaVal, radioVal,
    } = this.state;
    return (
      <div className="controlled">
        ...
        <form>
          ...
          <input type="text" name="controlled-text" id="controlled-text" value={textVal} onChange={this.onFormChange} /><br />

          <span>Select: </span>
          <select name="controlled-select" id="controlled-select" value={selectVal} onChange={this.onFormChange}>
          ...
          <select name="controlled-multi-select" id="controlled-multi-select" multiple value={multiSelectVal} onChange={this.onFormChange}>
          ...
          <textarea name="controlled-text-area" id="controlled-text-area" value={textAreaVal} onChange={this.onFormChange} /><br />
